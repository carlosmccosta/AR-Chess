...
#define CHESS_ENGINE_SKILL_LEVEL_TIME_ALLOWED_INCREASE_MS 50

#define PIECE_HEIGHT_OFFSET -0.01
#define PIECE_OUTSIDE_OFFSET 12
#define PIECE_MOVE_ANIMATION_TRAVEL_SPEED 48
#define PIECE_MOVE_MAX_ANIMATION_DURATION_SECONDS (BOARD_SQUARE_SIZE * 4 / PIECE_MOVE_ANIMATION_TRAVEL_SPEED)
...
#define GAME_STATUS_TEXT_POSITION_WHITE_SIDE Vec3(0, -GAME_STATUS_TEXT_Y_POSITION, PLAYER_STATUS_Z_OFFSET)
#define GAME_STATUS_TEXT_Y_POSITION 4.65 * BOARD_SQUARE_SIZE
#define GAME_STATUS_TEXT_POSITION_BLACK_SIDE Vec3(0,  GAME_STATUS_TEXT_Y_POSITION, PLAYER_STATUS_Z_OFFSET)
#define GAME_STATUS_TEXT_SIZE 12
#define GAME_STATUS_TEXT_DEPTH 4
#define GAME_STATUS_TEXT_COLOR Vec4(0.74, 0.51, 0.14, 0.8)
#define GAME_STATUS_TEXT_SCALE_ANIMATION_DURATION_SECONDS 2
...
#define SKILL_LEVEL_SELECTOR_TITLE_COLOR Vec4(0.0, 0.66, 1.0, 0.8)
#define SKILL_LEVEL_SELECTOR_NUMBER_COLOR Vec4(0.6, 0.8, 0.06, 0.8)
